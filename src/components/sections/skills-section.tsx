...
export default function SkillsSection() {
  ...
  return (
    <section id="skills" ref={sectionRef} className={cn("container mx-auto px-4 animate-on-scroll", isVisible ? "is-visible" : "")}>
      <h2 className="text-4xl md:text-5xl font-extrabold text-center mb-20 tracking-tight">My Tech Stack</h2>
